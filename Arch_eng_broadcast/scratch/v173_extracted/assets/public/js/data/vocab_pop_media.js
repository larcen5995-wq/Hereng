...
const VOCAB_POP_MEDIA = window.VOCAB_POP_MEDIA =  {
  tv_slang: {
    ...
    sentences: [
      { target: "Come on, spill the tea! What happened on your date last night?", translation: "어서 비밀 좀 털어봐! 어젯밤 데이트에서 무슨 일 있었어?" },
      { target: "He totally ghosted me after our first meeting.", translation: "그 사람은 첫 만남 이후로 완전 잠수 탔어." },
      { target: "I have a big presentation early tomorrow morning, so I am going to hit the sack.", translation: "내일 아침 일찍 중요한 발표가 있어서 난 이만 자러 갈게." },
      { target: "No cap, this is the best movie I have ever watched in my life.", translation: "거짓말 아니고, 이거 내 인생 최고 영화야." },
      { target: "Hit me up whenever you are free to hang out.", translation: "놀 시간 될 때 언제든 나한테 연락해." }
    ]
  },
  ...
  kpop_hallyu: {
    ...
    sentences: [
      { target: "Who is your ultimate bias in this group?", translation: "이 그룹에서 너의 최애 멤버가 누구야?" },
      { target: "Their new title track achieved an instant all-kill on all music charts.", translation: "그들의 새 타이틀곡은 모든 음원 차트에서 즉시 올킬을 달성했습니다." }
    ]
  },
  ...
  anime_japan: {
    ...
    sentences: [
      { target: "あきらめないで！最後まで頑張ろう！", translation: "포기하지 마! 끝까지 힘내자!" },
      { target: "君なら絶対にできると信じてるよ！", translation: "너라면 틀림없이 해낼 수 있다고 믿고 있어!" }
    ]
  }
};
