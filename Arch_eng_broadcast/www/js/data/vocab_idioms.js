...
const VOCAB_IDIOMS = window.VOCAB_IDIOMS =  {
  idioms_elem: {
    ...
    sentences: [
      { target: 'Please look at the blackboard when the teacher is speaking.', translation: '선생님이 말씀하실 때 칠판을 보세요.', phonetic: '' },
      { target: 'I wake up at seven o\'clock every morning.', translation: '나는 매일 아침 7시에 일어납니다.', phonetic: '' }
    ]
  },
  ...
  idioms_mid: {
    ...
    sentences: [
      { target: 'Never put off until tomorrow what you can do today.', translation: '오늘 할 수 있는 일을 내일로 미루지 마세요.', phonetic: '' },
      { target: 'We are looking forward to meeting your family next week.', translation: '우리는 다음 주에 당신의 가족을 만나기를 기대하고 있습니다.', phonetic: '' }
    ]
  },
  ...
  idioms_high: {
    ...
    sentences: [
      { target: 'The research team was able to carry out the complex experiment successfully.', translation: '연구팀은 복잡한 실험을 성공적으로 수행할 수 있었습니다.', phonetic: '' },
      { target: 'I am delivering this speech on behalf of our entire department.', translation: '저는 저희 부서 전체를 대표하여 이 연설을 하고 있습니다.', phonetic: '' }
    ]
  },
  ...
  idioms_daily: {
    ...
    sentences: [
      { target: 'It is getting late, so let us call it a day and go home.', translation: '늦었으니 오늘 일을 여기서 마무리하고 집으로 갑시다.', phonetic: '' },
      { target: 'Her suggestion really hit the nail on the head regarding our budget issue.', translation: '그녀의 제안은 우리 예산 문제와 관련하여 정말 정곡을 찔렀습니다.', phonetic: '' }
    ]
  }
};
